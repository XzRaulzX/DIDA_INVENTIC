...
class  Media {
  ...
  public $fileType;
  public $fileTempPath;
  //Variables que indican dónde se almacenarán las imágenes subidas
  ...
  // Tipos permitidos de archivos imagen
 ...
 /*--------------------------------------------------------------*/
 /* Función para el procesamiento de archivos multimedia
 /*--------------------------------------------------------------*/
  ...
  /*--------------------------------------------------------------*/
  /* Función para el procesamiento de la imagen de usuario
  /*--------------------------------------------------------------*/
 ...
 /*--------------------------------------------------------------*/
 /* Función para borrar la imagen antigua de usuario
 /*--------------------------------------------------------------*/
  public function user_image_destroy($id){
     $image = find_by_id('usuarios',$id);
     if($image['imagen'] === 'sin_imagen.png')
     {
       return true;
     } else {
...
/*--------------------------------------------------------------*/
/* Función para insertar una imagen en la tabla media
/*--------------------------------------------------------------*/
...
/*--------------------------------------------------------------*/
/* Función para eliminar un registro de imagen de la tabla media
/*--------------------------------------------------------------*/
