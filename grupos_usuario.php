<?php
  ...
  $all_groups = find_all('grupos_usuario');
?>
  ...
  <div class="col-md-12">
    ...
    <div class="panel-heading clearfix">
      <strong>
       ...
       <a href="add_grupo.php" class="btn btn-info pull-right btn-sm"> Agregar grupo</a>
    </div>
          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                ...
                <a href="delete_grupo.php?id=<?php echo (int)$a_group['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Eliminar">
